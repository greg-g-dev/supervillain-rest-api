...
def get_endpoints():
  endpoints = { "/api/villains" : "GET - Retrieves all villain data from the database", "/api/villains/delete" : "POST - Deletes a villain from the database", "/api/villains/add" : "POST - Adds a villain to the database"
  }
